...
# import src.data_standardize.Exp_to_standard
#
...
#             sweeplogs = src.Builders.Util.metadata_to_JSON(sweeplogs)
#             mags = {'mag' + id: src.data_standardize.Exp_to_standard.mag_from_json(sweeplogs, id, mag_type=instruments['magnet']) for id in ['x', 'y', 'z']}
