...
if config_path is None:
    msg = (
        f'Warning: No "DatAnalysisConfig" environment variable found, there will be no default config. \n\n'
...
def get_local_config(path: Optional[str] = None) -> dict:
    ...
    if path:
        ...
        raise RuntimeError(
            f'Path to DatAnalysisConfig not found. Please set "DatAnalysisConfig" environment variable to point to a "config.toml" file, or wherever you want that file to exist'
        )
