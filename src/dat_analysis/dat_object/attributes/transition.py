...
#         title = '2D i_sense'
#         ax = dat_analysis.Plotting.Mpl.Plots.display_2d(Data.x_array, Data.y_array, data, ax, x_label=dat.Logs.x_label,
...
#         ax = dat_analysis.Plotting.Mpl.Plots.display_1d(dat.Transition.x_array, data, ax, dat=dat, title=title,
...
#         ax = dat_analysis.Plotting.Mpl.Plots.display_1d(dat.Data.y_array, data, ax, dat=dat, title=title,
...
#         ax = axs[i]
#         dat_analysis.Plotting.Mpl.Plots.dac_table(ax, dat)
#         fig = plt.gcf()
#         try:
#             fig.suptitle(f'Dat{dat.datnum}')
#             dat_analysis.Plotting.Mpl.PlotUtil.add_standard_fig_info(fig)
#             dat_analysis.Plotting.Mpl.PlotUtil.add_to_fig_text(fig,
